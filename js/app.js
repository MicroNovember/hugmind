...
const greetings = {
    happy: [
        ...
        // เพิ่มอีก 3
        'เห็นคุณยิ้มได้แบบนี้ โลกดูสดใสขึ้นเยอะเลยค่ะ รักษาความรู้สึกนี้ไว้นะคะ 💖',
        'ความสุขเล็กๆ ระหว่างวันคือของขวัญที่ดีที่สุด วันนี้คุณได้รับมันแล้วนะคะ 🎁',
        'ดีใจจังที่วันนี้เป็นวันที่ดีของคุณ ขอให้พรุ่งนี้ดียิ่งกว่าเดิมขึ้นไปอีกนะ! 🚀'
    ],
    calm: [
        ...
        // เพิ่มอีก 3
        'ความเงียบสงบช่วยให้เราได้ยินเสียงหัวใจตัวเองชัดขึ้น ดีใจที่คุณได้พักนะคะ 🧘',
        'อยู่กับปัจจุบันและลมหายใจที่ผ่อนคลาย คือช่วงเวลาที่แสนพิเศษจริงๆ ค่ะ ☁️',
        'ขอให้ความสงบในใจนี้ เป็นเกราะคุ้มครองคุณจากความวุ่นวายภายนอกนะคะ 🛡️'
    ],
    sad: [
        ...
        // เพิ่มอีก 3
        'กอดปลอบใจนะคะ ร้องไห้ได้ไม่เป็นไรเลย พรุ่งนี้ค่อยเริ่มใหม่ด้วยกันนะ 🫂',
        'ท้องฟ้ายังมีเมฆครึ้ม ใจเราก็มีวันหม่นๆ ได้ แสงแดดจะกลับมาหาคุณแน่นอนค่ะ ⛅',
        'อนุญาตให้ตัวเองได้อ่อนแอบ้างนะคะ คุณเก่งมากแล้วที่ผ่านวันนี้มาได้ 🕯️'
    ],
    anxious: [
        ...
        // เพิ่มอีก 3
        'ลองวางความกังวลไว้ข้างๆ สักครู่ แล้วหาอะไรอุ่นๆ ดื่มดูไหมคะ จะได้สบายใจขึ้น ☕',
        'คุณไม่จำเป็นต้องแก้ปัญหาทุกอย่างในตอนนี้ แค่ผ่านนาทีนี้ไปได้ก็พอแล้วค่ะ ⏳',
        'มานับ 1-10 ช้าๆ ไปพร้อมกันนะคะ ความกังวลนี้มันจะค่อยๆ จางไปเองค่ะ 🎈'
    ],
    energetic: [
        ...
        // เพิ่มอีก 3
        'ไฟแรงแบบนี้ ลุยเลยค่ะ! ความสำเร็จรอให้คุณไปคว้าอยู่ไม่ไกลแล้ว 🏆',
        'ออร่าความมุ่งมั่นของคุณกระจายออกมาเลย! พร้อมเป็นกำลังใจให้ทุกเป้าหมายนะคะ ⚡',
        'พลังล้นเหลือแบบนี้ อย่าลืมส่งต่อแรงบันดาลใจให้คนรอบข้างด้วยนะคะ 🌟'
    ],
    neutral: [
        ...
        // เพิ่มอีก 3
        'ความธรรมดาที่แสนพิเศษ คือการได้ใช้ชีวิตเรียบง่ายแต่มีความสุขในแบบเรา 🏡',
        'ไม่ต้องรีบร้อนไปไหน วันสบายๆ แบบนี้คือโอกาสดีที่จะรักตัวเองให้มากขึ้นค่ะ 💗',
        'ขอให้วันนี้เป็นวันที่ราบรื่นเหมือนสายน้ำ ไหลไปเรื่อยๆ อย่างสบายใจนะคะ 🌊'
    ],
    late_night: [ // แถมหมวดดึกที่นุ่มนวลให้ 6 ข้อความเลยครับ
        'ดึกแล้ว แวะมาส่งเข้านอนน้า ฝันดีล่วงหน้านะคะ 🌙',
        'ทักทายยามดึกค่ะ หวังว่าคืนนี้จะเป็นช่วงเวลาที่ผ่อนคลายของคุณนะคะ ✨',
        'ดึกป่านนี้แล้ว พักสายตาซักนิดดีไหมคะ ร่างกายจะได้พักผ่อนเต็มที่ 😴',
        'แวะมาดูว่ามีคนยังไม่นอนไหม อย่าลืมห่มผ้าหนาๆ นะคะ เป็นห่วงนะ 🧸',
        'ปล่อยวางเรื่องของวันนี้ไว้ข้างหมอน แล้วหลับตาลงให้สนิทนะคะ ฝันดีค่ะ 💤',
        'คืนนี้ขอให้เป็นคืนที่เงียบสงบและหลับสบายที่สุดของคุณนะคะ ราตรีสวัสดิ์ค่ะ 🌌'
    ]
};
        ...
        initDarkMode() {
            ...
            // ถ้ามีคลาส dark ใน HTML อยู่แล้ว ให้ใช้ค่านั้น มิฉะนั้นให้เริ่มต้นด้วย dark mode
            if (hasHtmlClass) {
                this.darkMode = true;
                // บันทึกค่าเริ่มต้นไว้ใน localStorage
                if (savedDarkMode === null) {
                    localStorage.setItem('darkMode', 'true');
                }
            } else {
                // เริ่มต้นด้วย dark mode เสมอ ถ้าไม่มีการบันทึกไว้
